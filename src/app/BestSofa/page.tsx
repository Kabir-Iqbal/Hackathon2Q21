                ...
                <div className=" pt-[132px] w-[90%] mx-auto " >
                    ...
                    <div className=" flex flex-col md:flex-row my-10 gap-0 md:gap-10 h-[1070px]  md:h-[600px] " >
                        ...
                        <div className="flex-1 h-[400px]  md:h-[600px]  " >
                            <Image className="w-full h-full " src="/images/big image.jpg" width={400} height={400} alt="The Poplar suede sofa " />
                        </div>
                        {/* left */}
                        <div className="flex-1 flex flex-col gap-2 my-10 ">
                            <h1 className="font-bold " > The Poplar suede sofa </h1>
                            <p>£980 </p>
                            <div className="text-[#505977] flex flex-col gap-3   " >
                                ...
                                <div className=" flex justify-between  " >
                                    {/* right */}
                                    <div className="flex flex-col px-5 sm:flex-row gap-5 mt-10 items-center">
                                        <h2 className="text-18px" > Amount: </h2>
                                    ...
                                    <div className=" w-[150px] mt-20   sm:justify-center sm:mt-12  text-white font-semibold  flex items-center " >
                                        <button type="submit" className="px-5 py-2 bg-[#2a254b] items-center " >Add To Cart</button>
                                    </div>
                                </div>
                            </div>
                        </div>
